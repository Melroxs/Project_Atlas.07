...
export const decisionScores = pgTable(
  'decision_scores',
  {
    ...
    evidenceScore: numeric('evidence_score', { precision: 3, scale: 2 }),
    coverageScore: numeric('coverage_score', { precision: 3, scale: 2 }),
    complianceScore: numeric('compliance_score', { precision: 3, scale: 2 }),
    riskFactorScore: numeric('risk_factor_score', { precision: 3, scale: 2 }),
